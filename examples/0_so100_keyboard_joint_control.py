...
def main():
    ...
    try:
        ...
        try:
            ...
            print(f"Warning: Keyboard connection failed: {e}")
            print("Continuing without keyboard input (robot will stay in zero position)")
            # Set keyboard to None to indicate no keyboard control
            keyboard = None
        ...
        if keyboard is not None:
            ...
            print("No keyboard control available. Robot will stay in zero position.")
